...
public class AddDinamicoDe9TextFields extends JInternalFrame{
    ...
    public AddDinamicoDe9TextFields() throws ParseException{   
  ...
  public static void main(String args[]) throws ParseException{
    AddDinamicoDe9TextFields app = new AddDinamicoDe9TextFields();
