...
public class AddDinamicoDe8TextFields extends JInternalFrame{
    ...
    public AddDinamicoDe8TextFields() throws ParseException{   
  ...
  public static void main(String args[]) throws ParseException{
    AddDinamicoDe8TextFields app = new AddDinamicoDe8TextFields();
