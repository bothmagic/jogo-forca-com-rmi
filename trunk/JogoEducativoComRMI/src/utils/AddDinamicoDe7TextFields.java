...
public class AddDinamicoDe7TextFields extends JInternalFrame{
    ...
    public AddDinamicoDe7TextFields() throws ParseException{   
  ...
  public static void main(String args[]) throws ParseException{
    AddDinamicoDe7TextFields app = new AddDinamicoDe7TextFields();
