...
public class AddDinamicoDe5TextFields extends JInternalFrame{
    ...
    public AddDinamicoDe5TextFields() throws ParseException{   
  ...
  public static void main(String args[]) throws ParseException{
    AddDinamicoDe5TextFields app = new AddDinamicoDe5TextFields();
